...
export default function RightControl() {
  return (
    <div className="w-[100px] h-[250px] border-4 border-solid rounded-r-lg bg-red-500">
        ...
        <div className='flex items-center justify-center'>
          ...
          <button className='items-center justify-right w-[25px] h-[25px] border-2 border-solid rounded-[80px] bg-black text-white'>A</button>
        </div>
